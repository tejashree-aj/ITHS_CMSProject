...
namespace CMS_APIProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           (options =>
           {
               options.UseSqlServer(Configuration.GetConnectionString("CMSDBContextConnection"));
           });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CMS_APIProject", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CMS_APIProject v1"));
