...
namespace ITHS_CMSProject.Pages
{
    public class TestModel : PageModel
    {
        ...
        public TestModel(ILogger<TestModel> logger, IConfiguration configuration, UserManager<UserInformation> userManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var pageId = Pages.Where(x => string.Equals(x.PageLink, "/Test", StringComparison.OrdinalIgnoreCase)).FirstOrDefault().PageId;
