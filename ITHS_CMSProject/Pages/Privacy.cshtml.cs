...
namespace ITHS_CMSProject.Pages
{
    public class PrivacyModel : PageModel
    {
        ...
        public PrivacyModel(ILogger<PrivacyModel> logger, IConfiguration configuration, UserManager<UserInformation> userManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var pageId = Pages.Where(x => string.Equals(x.PageLink, "/Privacy", StringComparison.OrdinalIgnoreCase)).FirstOrDefault().PageId;
