...
namespace ITHS_CMSProject.Pages
{
    public class AboutUsModel : PageModel
    {
        ...
        public AboutUsModel(ILogger<AboutUsModel> logger, IConfiguration configuration, UserManager<UserInformation> userManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var pageId = Pages.Where(x => string.Equals(x.PageLink, "/AboutUs", StringComparison.OrdinalIgnoreCase)).FirstOrDefault().PageId;
